...
SLAGIO_EXAMENS.havo.nl = {
  ...
  vragen: [
    ...
    { nr:1, opgave:1, punten:2, type:'open', domein:'Argumentatie',
      vraag:'Wat is het hoofdstandpunt van de schrijver in deze alinea? Leg ook uit waaraan je ziet dat dit een standpunt (een te verdedigen mening) is en geen feit.',
      antwoord:'Het standpunt is dat scholen smartphones tijdens de les helemaal zouden moeten verbieden. Je ziet dat het een standpunt is en geen feit doordat het een mening is waarover je van mening kunt verschillen en die de schrijver met argumenten moet onderbouwen (let op "zouden moeten"). Een feit is controleerbaar en onbetwistbaar; dit standpunt is dat niet, het moet overtuigen.',
      antwoord_rubric:'1 punt: standpunt = smartphones zouden in de les verboden moeten worden. 1 punt: uitleg dat het een (betwistbare, met argumenten onderbouwde) mening is en geen controleerbaar feit.' },
    { nr:2, opgave:1, punten:3, type:'open', domein:'Argumentatie',
      vraag:'De schrijver geeft twee argumenten voor zijn standpunt. Noem beide argumenten en beoordeel welk van de twee het best is onderbouwd. Betrek de tekst in je oordeel.',
      antwoord:'Argument 1: telefoons leiden leerlingen voortdurend af (verstoren de concentratie). Argument 2: een verbod gaat online pesten tegen. Argument 2 is het best onderbouwd, want de schrijver geeft er bewijs bij: "uit onderzoek van een lerarenvakbond blijkt dat online pesten vaak juist tijdens schooltijd begint". Argument 1 is alleen een bewering zonder onderzoek of cijfers erbij, en is dus minder sterk onderbouwd.',
      antwoord_rubric:'1 punt: beide argumenten correct (afleiding én pesten tegengaan). 1 punt: argument 2 is het best onderbouwd. 1 punt: omdat er bij argument 2 onderzoek/bewijs staat en bij argument 1 niet.' },
    ...
    { nr:4, opgave:1, punten:3, type:'open', domein:'Argumentatie',
      vraag:'De schrijver noemt alleen voordelen van een telefoonverbod. Bedenk één weerwoord (tegenargument) dat een tegenstander tegen dit standpunt kan inbrengen, en leg uit waarom een betoog juist sterker wordt als de schrijver zo\'n tegenargument noemt en vervolgens weerlegt.',
      antwoord:'Een mogelijk tegenargument is bijvoorbeeld: een telefoon kan in de les ook nuttig zijn (opzoeken, agenda, rekenmachine, leren met apps), of leerlingen moeten juist leren zélf verantwoord met hun telefoon om te gaan. Een betoog wordt sterker als de schrijver zo\'n tegenargument noemt en weerlegt, omdat hij dan laat zien dat hij de andere kant heeft overwogen; dat maakt zijn betoog overtuigender en geloofwaardiger en het ontkracht bij voorbaat de kritiek van de tegenstander.',
      antwoord_rubric:'1 punt: een plausibel tegenargument tegen het verbod. 1 punt: het betoog wordt overtuigender/geloofwaardiger doordat de schrijver de andere kant overweegt. 1 punt: het weerleggen ontkracht de kritiek van de tegenstander bij voorbaat.' },
    ...
    { nr:6, opgave:2, punten:2, type:'open', domein:'Leesvaardigheid',
