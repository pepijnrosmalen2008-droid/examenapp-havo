...
function openVak(id,_noHash){
  ...
  if(_aeName){
    ...
    let _ch=`<div class="ce-archief-card" style="margin-top:10px;border-radius:12px;overflow:hidden;border:1px solid rgba(var(--or-rgb),.35);background:rgba(var(--or-rgb),.05)"><div style="display:flex;align-items:center;justify-content:space-between;padding:9px 12px;cursor:pointer;gap:10px;user-select:none" onclick="this.closest('.ce-archief-card').classList.toggle('open')"><div style="display:flex;align-items:center;gap:9px;min-width:0"><div style="width:26px;height:26px;border-radius:7px;background:rgba(var(--or-rgb),.16);display:flex;align-items:center;justify-content:center;font-size:13px;flex-shrink:0">📄</div><div style="min-width:0"><div style="font-size:13.5px;font-weight:800;color:var(--or)">Oude examens</div><div style="font-size:11px;color:var(--mu)">Opgaven &amp; antwoorden per jaar</div></div></div><div style="display:flex;align-items:center;gap:5px;flex-shrink:0"><span style="font-size:11px;font-weight:700;color:var(--or)">Openen</span><div style="width:22px;height:22px;border-radius:7px;background:rgba(var(--or-rgb),.15);display:flex;align-items:center;justify-content:center;font-size:11px;color:var(--or);transition:transform .22s" class="ce-arr">▼</div></div></div><div class="ce-archief-body" style="display:none;padding:0 14px 14px">`;
