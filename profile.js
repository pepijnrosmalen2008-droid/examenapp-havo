...
const ANIMAL_EVOLUTIONS=[
  ...
  {id:'olifant', n:'Olifant', s:['','','','','',''], fallback:['🐘','🐘','🐘','🐘','🐘','🐘'],
   svg:[
    '<svg viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"><ellipse cx="30" cy="52" rx="13" ry="3" fill="#3a4452" opacity=".16"/><ellipse cx="14" cy="30" rx="8" ry="9" fill="#aab6c2"/><ellipse cx="46" cy="30" rx="8" ry="9" fill="#aab6c2"/><circle cx="30" cy="30" r="14" fill="#b4c0cc"/><path d="M30 36 q-3 0 -3 5 q0 4 3 5 q3 -1 3 -5 q0 -5 -3 -5Z" fill="#aab6c2"/><circle cx="24" cy="28" r="3.6" fill="#fff"/><circle cx="36" cy="28" r="3.6" fill="#fff"/><circle cx="24.4" cy="29" r="2" fill="#3a3028"/><circle cx="35.6" cy="29" r="2" fill="#3a3028"/><circle cx="23.5" cy="27.6" r=".9" fill="#fff"/><circle cx="34.7" cy="27.6" r=".9" fill="#fff"/></svg>',
    '<svg viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"><ellipse cx="30" cy="53" rx="14" ry="3" fill="#3a4452" opacity=".18"/><ellipse cx="12" cy="30" rx="9" ry="10.5" fill="#a4b0bd"/><ellipse cx="48" cy="30" rx="9" ry="10.5" fill="#a4b0bd"/><ellipse cx="12" cy="31" rx="5" ry="6" fill="#c8a0b0" opacity=".5"/><ellipse cx="48" cy="31" rx="5" ry="6" fill="#c8a0b0" opacity=".5"/><circle cx="30" cy="30" r="15" fill="#b4c0cc"/><path d="M30 35 q-3.4 0 -3.4 6 q0 5 3.4 6 q3.4 -1 3.4 -6 q0 -6 -3.4 -6Z" fill="#aab6c2"/><circle cx="24" cy="28" r="3.8" fill="#fff"/><circle cx="36" cy="28" r="3.8" fill="#fff"/><circle cx="24.4" cy="29" r="2.1" fill="#3a3028"/><circle cx="35.6" cy="29" r="2.1" fill="#3a3028"/><circle cx="23.4" cy="27.6" r="1" fill="#fff"/><circle cx="34.6" cy="27.6" r="1" fill="#fff"/></svg>',
    '<svg viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"><ellipse cx="30" cy="54" rx="15" ry="3" fill="#2a323c" opacity=".2"/><ellipse cx="10" cy="29" rx="10" ry="12" fill="#9eaab7"/><ellipse cx="50" cy="29" rx="10" ry="12" fill="#9eaab7"/><ellipse cx="10" cy="30" rx="5.5" ry="7" fill="#c8a0b0" opacity=".5"/><ellipse cx="50" cy="30" rx="5.5" ry="7" fill="#c8a0b0" opacity=".5"/><circle cx="30" cy="30" r="16" fill="#b0bcc8"/><path d="M30 35 q-3.6 0 -3.6 7 q0 6 3.6 7 q3.6 -1 3.6 -7 q0 -7 -3.6 -7Z" fill="#a4b0bd"/><path d="M27 47 l-2 2 M33 47 l2 2" stroke="#f0ece4" stroke-width="2.4" stroke-linecap="round"/><circle cx="23.5" cy="28" r="4" fill="#fff"/><circle cx="36.5" cy="28" r="4" fill="#fff"/><circle cx="24" cy="29" r="2.2" fill="#33291f"/><circle cx="36" cy="29" r="2.2" fill="#33291f"/><circle cx="22.9" cy="27.6" r="1" fill="#fff"/><circle cx="34.9" cy="27.6" r="1" fill="#fff"/></svg>',
    '<svg viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"><ellipse cx="30" cy="55" rx="16" ry="3" fill="#222a34" opacity=".22"/><ellipse cx="8" cy="29" rx="11" ry="13" fill="#96a3b0"/><ellipse cx="52" cy="29" rx="11" ry="13" fill="#96a3b0"/><ellipse cx="8" cy="30" rx="6" ry="7.5" fill="#c8a0b0" opacity=".5"/><ellipse cx="52" cy="30" rx="6" ry="7.5" fill="#c8a0b0" opacity=".5"/><circle cx="30" cy="29" r="17" fill="#abb8c4"/><path d="M30 35 q-3.8 0 -3.8 8 q0 7 3.8 8 q3.8 -1 3.8 -8 q0 -8 -3.8 -8Z" fill="#9eaab7"/><path d="M26 49 l-2.5 3 M34 49 l2.5 3" stroke="#f3efe7" stroke-width="3" stroke-linecap="round"/><circle cx="23" cy="27" r="4.2" fill="#fff"/><circle cx="37" cy="27" r="4.2" fill="#fff"/><circle cx="23.6" cy="28" r="2.3" fill="#2e251c"/><circle cx="36.4" cy="28" r="2.3" fill="#2e251c"/><circle cx="22.4" cy="26.6" r="1.1" fill="#fff"/><circle cx="35.2" cy="26.6" r="1.1" fill="#fff"/></svg>',
    '<svg viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"><ellipse cx="30" cy="56" rx="16" ry="3" fill="#161c24" opacity=".24"/><ellipse cx="7" cy="28" rx="11.5" ry="14" fill="#8e9ba8"/><ellipse cx="53" cy="28" rx="11.5" ry="14" fill="#8e9ba8"/><ellipse cx="7" cy="29" rx="6.5" ry="8" fill="#c8a0b0" opacity=".5"/><ellipse cx="53" cy="29" rx="6.5" ry="8" fill="#c8a0b0" opacity=".5"/><circle cx="30" cy="29" r="18" fill="#a6b3bf"/><path d="M30 35 q-4 0 -4 9 q0 8 4 9 q4 -1 4 -9 q0 -9 -4 -9Z" fill="#96a3b0"/><path d="M25.5 50 l-3 3.5 M34.5 50 l3 3.5" stroke="#f5f1e9" stroke-width="3.4" stroke-linecap="round"/><circle cx="22.5" cy="27" r="4.4" fill="#fff"/><circle cx="37.5" cy="27" r="4.4" fill="#fff"/><circle cx="23.1" cy="28" r="2.4" fill="#281f17"/><circle cx="36.9" cy="28" r="2.4" fill="#281f17"/><circle cx="21.9" cy="26.5" r="1.2" fill="#fff"/><circle cx="35.7" cy="26.5" r="1.2" fill="#fff"/><path d="M16 23 q4 -2 7 0 M44 23 q-4 -2 -7 0" stroke="#7a8694" stroke-width="1.6" fill="none" stroke-linecap="round"/></svg>',
    '<svg viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"><ellipse cx="30" cy="57" rx="16" ry="2.8" fill="#161c24" opacity=".26"/><ellipse cx="7" cy="29" rx="11.5" ry="14" fill="#84919e"/><ellipse cx="53" cy="29" rx="11.5" ry="14" fill="#84919e"/><ellipse cx="7" cy="30" rx="6.5" ry="8" fill="#c8a0b0" opacity=".5"/><ellipse cx="53" cy="30" rx="6.5" ry="8" fill="#c8a0b0" opacity=".5"/><circle cx="30" cy="30" r="18" fill="#a6b3bf"/><path d="M30 4 l3 5.5 6 .7 -4.5 4.3 1 6 -5.5 -3 -5.5 3 1 -6 -4.5 -4.3 6 -.7Z" fill="#f9cf4d" stroke="#dca91e" stroke-width="1" stroke-linejoin="round"/><path d="M30 36 q-4 0 -4 9 q0 8 4 9 q4 -1 4 -9 q0 -9 -4 -9Z" fill="#96a3b0"/><path d="M25.5 51 l-3 3.5 M34.5 51 l3 3.5" stroke="#f5f1e9" stroke-width="3.4" stroke-linecap="round"/><circle cx="22.5" cy="28" r="4.4" fill="#fff"/><circle cx="37.5" cy="28" r="4.4" fill="#fff"/><circle cx="23.1" cy="29" r="2.4" fill="#281f17"/><circle cx="36.9" cy="29" r="2.4" fill="#281f17"/><circle cx="21.9" cy="27.5" r="1.2" fill="#fff"/><circle cx="35.7" cy="27.5" r="1.2" fill="#fff"/></svg>'
   ],
   lbl:['Olifantje','Speels Kalf','Jonge Stoffel','Slagtand','Reuzenstier','Gouden Olifant','Mammoetkoning'],
   desc:['Klein, met flaporen en een onthoudgeheugen.','Speelt met zijn slurf, vergeet nooit een feitje.','Eerste slagtanden! Stampt door de stof.','Een geheugen als een olifant. Letterlijk.','Niets vergeet hij. Geen formule, geen datum.','Verguld van slurf tot slagtand. Bijna onaantastbaar.','De mammoetkoning. Vergeet geen enkel examenfeit.'],
   evoMsg:['🐘 Je olifantje vergeet nooit een feitje!','🐘 Eerste slagtanden! Je Olifant stampt door de stof.','🐘 Slagtand ontwaakt - geheugen als een olifant.','🐘 REUZENSTIER! Geen formule ontsnapt aan je geheugen.','🏅 GOUDEN OLIFANT! Je huid glanst als puur goud.','👑 MAMMOETKONING! De ultieme, gekroonde vorm.']},
  ...
  {id:'beer', n:'Beer', s:['','','','','',''], fallback:['🐻','🐻','🐻','🐻','🐻','🐻'],
   svg:[
    '<svg viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"><ellipse cx="30" cy="51" rx="12" ry="3" fill="#3a2410" opacity=".16"/><circle cx="19" cy="22" r="6" fill="#a06a3c"/><circle cx="41" cy="22" r="6" fill="#a06a3c"/><circle cx="19" cy="22" r="3" fill="#c89a6c"/><circle cx="41" cy="22" r="3" fill="#c89a6c"/><circle cx="30" cy="33" r="15" fill="#aa7444"/><ellipse cx="30" cy="38" rx="8" ry="6.5" fill="#dcc09a"/><circle cx="24" cy="31" r="4.2" fill="#fff"/><circle cx="36" cy="31" r="4.2" fill="#fff"/><circle cx="24.4" cy="32" r="2.3" fill="#2e1c0c"/><circle cx="35.6" cy="32" r="2.3" fill="#2e1c0c"/><circle cx="23.4" cy="30.4" r="1" fill="#fff"/><circle cx="34.6" cy="30.4" r="1" fill="#fff"/><ellipse cx="30" cy="36" rx="2.6" ry="1.9" fill="#2e1c0c"/><path d="M30 38 v2.4 q-2 1.4 -3.5 .6 M30 40.4 q2 1.4 3.5 .6" fill="none" stroke="#5a3a1a" stroke-width="1.3" stroke-linecap="round"/></svg>',
    '<svg viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"><ellipse cx="30" cy="52" rx="13" ry="3" fill="#3a2410" opacity=".18"/><circle cx="18" cy="21" r="6.4" fill="#996438"/><circle cx="42" cy="21" r="6.4" fill="#996438"/><circle cx="18" cy="21" r="3.2" fill="#c89a6c"/><circle cx="42" cy="21" r="3.2" fill="#c89a6c"/><circle cx="30" cy="33" r="16" fill="#a06e3e"/><ellipse cx="30" cy="38" rx="8.5" ry="7" fill="#dcc09a"/><circle cx="24" cy="31" r="4.4" fill="#fff"/><circle cx="36" cy="31" r="4.4" fill="#fff"/><circle cx="24.4" cy="32" r="2.4" fill="#2e1c0c"/><circle cx="35.6" cy="32" r="2.4" fill="#2e1c0c"/><circle cx="23.3" cy="30.4" r="1.1" fill="#fff"/><circle cx="34.5" cy="30.4" r="1.1" fill="#fff"/><ellipse cx="30" cy="36" rx="2.8" ry="2" fill="#2e1c0c"/><path d="M30 38 v2.6 q-2.2 1.5 -3.8 .6 M30 40.6 q2.2 1.5 3.8 .6" fill="none" stroke="#5a3a1a" stroke-width="1.4" stroke-linecap="round"/></svg>',
    '<svg viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"><ellipse cx="30" cy="54" rx="14" ry="3" fill="#241408" opacity=".2"/><circle cx="17" cy="20" r="6.8" fill="#8e5c34"/><circle cx="43" cy="20" r="6.8" fill="#8e5c34"/><circle cx="17" cy="20" r="3.4" fill="#c49668"/><circle cx="43" cy="20" r="3.4" fill="#c49668"/><circle cx="30" cy="33" r="17" fill="#996a3a"/><ellipse cx="30" cy="38" rx="9" ry="7.5" fill="#dcc09a"/><circle cx="23.5" cy="31" r="4.6" fill="#fff"/><circle cx="36.5" cy="31" r="4.6" fill="#fff"/><circle cx="24" cy="32" r="2.5" fill="#281808"/><circle cx="36" cy="32" r="2.5" fill="#281808"/><circle cx="22.8" cy="30.4" r="1.1" fill="#fff"/><circle cx="34.8" cy="30.4" r="1.1" fill="#fff"/><ellipse cx="30" cy="36" rx="3" ry="2.1" fill="#281808"/><path d="M30 38.1 v2.8 q-2.4 1.6 -4 .6 M30 40.9 q2.4 1.6 4 .6" fill="none" stroke="#523418" stroke-width="1.5" stroke-linecap="round"/></svg>',
    '<svg viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"><ellipse cx="30" cy="55" rx="15" ry="3" fill="#1c1006" opacity=".22"/><circle cx="15" cy="19" r="7.2" fill="#825230"/><circle cx="45" cy="19" r="7.2" fill="#825230"/><circle cx="15" cy="19" r="3.6" fill="#c09464"/><circle cx="45" cy="19" r="3.6" fill="#c09464"/><circle cx="30" cy="33" r="18.5" fill="#915f34"/><ellipse cx="30" cy="38" rx="9.5" ry="8" fill="#e0c49e"/><circle cx="23" cy="30" r="4.8" fill="#fff"/><circle cx="37" cy="30" r="4.8" fill="#fff"/><circle cx="23.6" cy="31" r="2.6" fill="#221406"/><circle cx="36.4" cy="31" r="2.6" fill="#221406"/><circle cx="22.4" cy="29.4" r="1.2" fill="#fff"/><circle cx="35.2" cy="29.4" r="1.2" fill="#fff"/><ellipse cx="30" cy="35.5" rx="3.2" ry="2.3" fill="#221406"/><path d="M30 37.8 v3 q-2.6 1.8 -4.4 .7 M30 40.8 q2.6 1.8 4.4 .7" fill="none" stroke="#4a3014" stroke-width="1.6" stroke-linecap="round"/></svg>',
    '<svg viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"><ellipse cx="30" cy="56" rx="16" ry="3" fill="#160c04" opacity=".24"/><circle cx="14" cy="18" r="7.6" fill="#78492a"/><circle cx="46" cy="18" r="7.6" fill="#78492a"/><circle cx="14" cy="18" r="3.8" fill="#bc9060"/><circle cx="46" cy="18" r="3.8" fill="#bc9060"/><circle cx="30" cy="33" r="19.5" fill="#885730"/><ellipse cx="30" cy="38" rx="10" ry="8.5" fill="#e4c8a2"/><circle cx="22.5" cy="30" r="5" fill="#fff"/><circle cx="37.5" cy="30" r="5" fill="#fff"/><circle cx="23.1" cy="31" r="2.7" fill="#1c1004"/><circle cx="36.9" cy="31" r="2.7" fill="#1c1004"/><circle cx="21.9" cy="29.3" r="1.3" fill="#fff"/><circle cx="35.7" cy="29.3" r="1.3" fill="#fff"/><ellipse cx="30" cy="35.5" rx="3.4" ry="2.4" fill="#1c1004"/><path d="M30 37.9 v3.2 q-2.8 1.9 -4.6 .7 M30 41.1 q2.8 1.9 4.6 .7" fill="none" stroke="#422c12" stroke-width="1.7" stroke-linecap="round"/></svg>',
    '<svg viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"><ellipse cx="30" cy="57" rx="16" ry="2.8" fill="#160c04" opacity=".26"/><circle cx="14" cy="19" r="7.6" fill="#6e4226"/><circle cx="46" cy="19" r="7.6" fill="#6e4226"/><circle cx="14" cy="19" r="3.8" fill="#bc9060"/><circle cx="46" cy="19" r="3.8" fill="#bc9060"/><circle cx="30" cy="34" r="19.5" fill="#885730"/><path d="M30 5 l3 5.5 6 .7 -4.5 4.3 1 6 -5.5 -3 -5.5 3 1 -6 -4.5 -4.3 6 -.7Z" fill="#f9cf4d" stroke="#dca91e" stroke-width="1" stroke-linejoin="round"/><ellipse cx="30" cy="39" rx="10" ry="8.5" fill="#e4c8a2"/><circle cx="22.5" cy="31" r="5" fill="#fff"/><circle cx="37.5" cy="31" r="5" fill="#fff"/><circle cx="23.1" cy="32" r="2.7" fill="#1c1004"/><circle cx="36.9" cy="32" r="2.7" fill="#1c1004"/><circle cx="21.9" cy="30.3" r="1.3" fill="#fff"/><circle cx="35.7" cy="30.3" r="1.3" fill="#fff"/><ellipse cx="30" cy="36.5" rx="3.4" ry="2.4" fill="#1c1004"/><path d="M30 38.9 v3.2 q-2.8 1.9 -4.6 .7 M30 42.1 q2.8 1.9 4.6 .7" fill="none" stroke="#422c12" stroke-width="1.7" stroke-linecap="round"/></svg>'
   ],
   lbl:['Beertje','Speels Welpje','Jonge Beer','Bruine Beer','Grizzly','Gouden Beer','Oerbeer'],
   desc:['Klein, knuffelig en dol op honingzoete kennis.','Speelt en bromt, maar leert gestaag door.','Eerste echte klauwen - graaft diep in de stof.','Sterk en standvastig. Geeft nooit op.','Niemand staat tussen hem en een hoog cijfer.','Verguld van vacht tot klauw. Bijna onaantastbaar.','De oerbeer. Brult en elk examen capituleert.'],
   evoMsg:['🐻 Je beertje is dol op honingzoete kennis!','🐻 Eerste klauwen! Je Beer graaft diep in de stof.','🐻 Bruine Beer ontwaakt - sterk en standvastig.','🐻 GRIZZLY! Niemand staat tussen jou en een 10.','🏅 GOUDEN BEER! Je vacht glanst als puur goud.','👑 OERBEER! De ultieme, gekroonde vorm.']},
  ...
  {id:'slijm', n:'Slijm', s:['','','','','',''], fallback:['🟢','🟢','🟢','🟢','🟢','🟢'],
   svg:[
    '<svg viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"><ellipse cx="30" cy="50" rx="11" ry="3" fill="#1f7a42" opacity=".18"/><path d="M19 48 q-2 -16 11 -16 q13 0 11 16Z" fill="#4cd07a"/><ellipse cx="25" cy="30" rx="4" ry="2.4" fill="#fff" opacity=".55"/><circle cx="25" cy="40" r="3.2" fill="#fff"/><circle cx="35" cy="40" r="3.2" fill="#fff"/><circle cx="25.3" cy="40.6" r="1.7" fill="#16402a"/><circle cx="34.7" cy="40.6" r="1.7" fill="#16402a"/><path d="M27 45 q3 2 6 0" fill="none" stroke="#2e9c54" stroke-width="1.4" stroke-linecap="round"/></svg>',
    '<svg viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"><ellipse cx="30" cy="51" rx="13" ry="3" fill="#1f7a42" opacity=".2"/><path d="M16 49 q-3 -19 14 -19 q17 0 14 19Z" fill="#48cc76"/><ellipse cx="24" cy="29" rx="5" ry="2.8" fill="#fff" opacity=".55"/><circle cx="24" cy="40" r="3.6" fill="#fff"/><circle cx="36" cy="40" r="3.6" fill="#fff"/><circle cx="24.4" cy="40.6" r="1.9" fill="#16402a"/><circle cx="35.6" cy="40.6" r="1.9" fill="#16402a"/><circle cx="23.4" cy="39.4" r=".8" fill="#fff"/><circle cx="34.6" cy="39.4" r=".8" fill="#fff"/><path d="M26 45 q4 2.5 8 0" fill="none" stroke="#2e9c54" stroke-width="1.5" stroke-linecap="round"/></svg>',
    '<svg viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"><ellipse cx="30" cy="53" rx="14" ry="3" fill="#155a30" opacity=".22"/><path d="M13 51 q-3 -22 17 -22 q20 0 17 22Z" fill="#44c772"/><path d="M20 30 q4 -3 8 -1 M38 30 q-4 -3 -8 -1" stroke="#7ee49e" stroke-width="1.4" fill="none" opacity=".6"/><ellipse cx="23" cy="30" rx="5.5" ry="3" fill="#fff" opacity=".55"/><circle cx="23.5" cy="40" r="3.9" fill="#fff"/><circle cx="36.5" cy="40" r="3.9" fill="#fff"/><circle cx="24" cy="40.6" r="2.1" fill="#123a24"/><circle cx="36" cy="40.6" r="2.1" fill="#123a24"/><circle cx="22.9" cy="39.2" r=".9" fill="#fff"/><circle cx="34.9" cy="39.2" r=".9" fill="#fff"/><path d="M25 45 q5 3 10 0" fill="none" stroke="#2a924e" stroke-width="1.6" stroke-linecap="round"/></svg>',
    '<svg viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"><ellipse cx="30" cy="55" rx="15" ry="3" fill="#0e4424" opacity=".24"/><path d="M10 53 q-3 -25 20 -25 q23 0 20 25Z" fill="#40c06e"/><ellipse cx="22" cy="30" rx="6" ry="3.2" fill="#fff" opacity=".55"/><circle cx="23" cy="40" r="4.2" fill="#fff"/><circle cx="37" cy="40" r="4.2" fill="#fff"/><circle cx="23.6" cy="40.6" r="2.3" fill="#0e3420"/><circle cx="36.4" cy="40.6" r="2.3" fill="#0e3420"/><circle cx="22.4" cy="39.1" r="1" fill="#fff"/><circle cx="35.2" cy="39.1" r="1" fill="#fff"/><path d="M24 45 q6 3.5 12 0" fill="none" stroke="#268848" stroke-width="1.7" stroke-linecap="round"/><circle cx="16" cy="46" r="2" fill="#7ee49e" opacity=".7"/><circle cx="44" cy="46" r="2" fill="#7ee49e" opacity=".7"/></svg>',
    '<svg viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"><ellipse cx="30" cy="56" rx="16" ry="3" fill="#0a3a1e" opacity=".26"/><path d="M8 54 q-3 -27 22 -27 q25 0 22 27Z" fill="#3cba68"/><ellipse cx="21" cy="30" rx="6.5" ry="3.4" fill="#fff" opacity=".55"/><circle cx="22.5" cy="39" r="4.4" fill="#fff"/><circle cx="37.5" cy="39" r="4.4" fill="#fff"/><circle cx="23.1" cy="39.6" r="2.4" fill="#0a2e1a"/><circle cx="36.9" cy="39.6" r="2.4" fill="#0a2e1a"/><circle cx="21.9" cy="38" r="1.1" fill="#fff"/><circle cx="35.7" cy="38" r="1.1" fill="#fff"/><path d="M23 45 q7 4 14 0" fill="none" stroke="#22804" stroke-width="1.8" stroke-linecap="round"/><path d="M23 45 q7 4 14 0" fill="none" stroke="#228044" stroke-width="1.8" stroke-linecap="round"/><circle cx="14" cy="46" r="2.2" fill="#7ee49e" opacity=".7"/><circle cx="46" cy="46" r="2.2" fill="#7ee49e" opacity=".7"/><circle cx="30" cy="50" r="2" fill="#7ee49e" opacity=".6"/></svg>',
    '<svg viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"><ellipse cx="30" cy="57" rx="16" ry="2.8" fill="#0a3a1e" opacity=".28"/><path d="M8 55 q-3 -27 22 -27 q25 0 22 27Z" fill="#34b060"/><path d="M30 7 l3 5.5 6 .7 -4.5 4.3 1 6 -5.5 -3 -5.5 3 1 -6 -4.5 -4.3 6 -.7Z" fill="#f9cf4d" stroke="#dca91e" stroke-width="1" stroke-linejoin="round" transform="translate(0,17)"/><ellipse cx="21" cy="31" rx="6.5" ry="3.4" fill="#fff" opacity=".55"/><circle cx="22.5" cy="40" r="4.4" fill="#fff"/><circle cx="37.5" cy="40" r="4.4" fill="#fff"/><circle cx="23.1" cy="40.6" r="2.4" fill="#08281600"/><circle cx="23.1" cy="40.6" r="2.4" fill="#082816"/><circle cx="36.9" cy="40.6" r="2.4" fill="#082816"/><circle cx="21.9" cy="39" r="1.1" fill="#fff"/><circle cx="35.7" cy="39" r="1.1" fill="#fff"/><path d="M23 46 q7 4 14 0" fill="none" stroke="#1e7840" stroke-width="1.8" stroke-linecap="round"/><circle cx="14" cy="47" r="2.2" fill="#7ee49e" opacity=".7"/><circle cx="46" cy="47" r="2.2" fill="#7ee49e" opacity=".7"/></svg>'
   ],
   lbl:['Druppeltje','Klein Slijm','Wiebel-Slijm','Slijmklont','Slijmreus','Gouden Slijm','Slijmkoning'],
   desc:['Een klein blubberdruppeltje vol leergierigheid.','Wiebelt vrolijk mee met elke vraag.','Verandert van vorm, maar nooit van doel: leren.','Slokt moeilijke stof op en verteert het traag.','Een onverwoestbare bal pure kennis.','Verguld en glanzend. Bijna onaantastbaar.','De slijmkoning. Onuitwisbaar, net als jouw kennis.'],
   evoMsg:['🟢 Je druppeltje wiebelt vrolijk mee!','🟢 Wiebel-Slijm verandert van vorm, nooit van doel.','🟢 Slijmklont slokt moeilijke stof op!','🟢 SLIJMREUS! Een onverwoestbare bal pure kennis.','🏅 GOUDEN SLIJM! Je glanst als puur goud.','👑 SLIJMKONING! De ultieme, gekroonde vorm.']},
  {id:'cactus', n:'Cactus', s:['','','','','',''], fallback:['🌵','🌵','🌵','🌵','🌵','🌵'],
   svg:[
    '<svg viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"><ellipse cx="30" cy="50" rx="9" ry="3" fill="#1f5a2a" opacity=".18"/><path d="M26 49 q-2 -14 4 -14 q6 0 4 14Z" fill="#52b85e"/><path d="M30 33 l0 -4" stroke="#3a9a48" stroke-width="1.6" stroke-linecap="round"/><circle cx="27" cy="41" r="2.6" fill="#fff"/><circle cx="33" cy="41" r="2.6" fill="#fff"/><circle cx="27.2" cy="41.5" r="1.4" fill="#1c4a26"/><circle cx="32.8" cy="41.5" r="1.4" fill="#1c4a26"/><path d="M28 45 q2 1.5 4 0" fill="none" stroke="#2e7d3a" stroke-width="1.2" stroke-linecap="round"/><path d="M28 38 l-1.5 -1 M32 38 l1.5 -1" stroke="#cfe8b0" stroke-width="1" stroke-linecap="round"/></svg>',
    '<svg viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"><ellipse cx="30" cy="51" rx="10" ry="3" fill="#1f5a2a" opacity=".2"/><path d="M25 50 q-3 -18 5 -18 q8 0 5 18Z" fill="#4eb45a"/><circle cx="26.5" cy="42" r="2.8" fill="#fff"/><circle cx="33.5" cy="42" r="2.8" fill="#fff"/><circle cx="26.8" cy="42.5" r="1.5" fill="#1c4a26"/><circle cx="33.2" cy="42.5" r="1.5" fill="#1c4a26"/><path d="M27 46.5 q3 2 6 0" fill="none" stroke="#2e7d3a" stroke-width="1.3" stroke-linecap="round"/><path d="M26 38 l-2 -1.5 M34 38 l2 -1.5 M27 34 l-1.5 -1.5 M33 34 l1.5 -1.5" stroke="#cfe8b0" stroke-width="1" stroke-linecap="round"/></svg>',
    '<svg viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"><ellipse cx="30" cy="53" rx="12" ry="3" fill="#15401e" opacity=".22"/><path d="M16 44 q-2 -10 5 -10 q6 0 5 8" fill="#46a852" stroke="#368a42" stroke-width="0"/><path d="M16 44 q-2 -10 5 -10 q5 0 5 7 l-3 0 q0 -4 -2 -4 q-3 0 -2 6Z" fill="#46a852"/><path d="M44 46 q2 -12 -5 -12 q-6 0 -5 9" fill="#46a852"/><path d="M44 46 q2 -12 -5 -12 q-5 0 -5 8 l3 0 q0 -5 2 -5 q3 0 2 7Z" fill="#46a852"/><path d="M24 52 q-3 -22 6 -22 q9 0 6 22Z" fill="#4cb058"/><circle cx="26.5" cy="40" r="3" fill="#fff"/><circle cx="33.5" cy="40" r="3" fill="#fff"/><circle cx="26.8" cy="40.6" r="1.6" fill="#163e1e"/><circle cx="33.2" cy="40.6" r="1.6" fill="#163e1e"/><path d="M27 45 q3 2 6 0" fill="none" stroke="#2a7536" stroke-width="1.4" stroke-linecap="round"/><path d="M30 33 l-1.5 -2 M30 33 l1.5 -2 M22 42 l-2 -1 M40 42 l2 -1" stroke="#d2ebb4" stroke-width="1" stroke-linecap="round"/></svg>',
    '<svg viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"><ellipse cx="30" cy="55" rx="13" ry="3" fill="#0e3416" opacity=".24"/><path d="M13 42 q-3 -13 6 -13 q7 0 6 10 l-3.5 0 q1 -6 -2.5 -6 q-4 0 -2.5 9Z" fill="#42a04e"/><path d="M47 44 q3 -15 -6 -15 q-7 0 -6 11 l3.5 0 q-1 -7 2.5 -7 q4 0 2.5 11Z" fill="#42a04e"/><path d="M22 54 q-3 -26 8 -26 q11 0 8 26Z" fill="#48ac54"/><circle cx="22" cy="35" r="2" fill="#f06a8a"/><circle cx="38" cy="35" r="2" fill="#f06a8a"/><circle cx="26" cy="40" r="3.2" fill="#fff"/><circle cx="34" cy="40" r="3.2" fill="#fff"/><circle cx="26.4" cy="40.6" r="1.7" fill="#123a1a"/><circle cx="33.6" cy="40.6" r="1.7" fill="#123a1a"/><path d="M26.5 45 q3.5 2.5 7 0" fill="none" stroke="#266e32" stroke-width="1.5" stroke-linecap="round"/><path d="M30 31 l-1.5 -2 M30 31 l1.5 -2 M20 41 l-2 -1 M40 41 l2 -1 M21 46 l-2 0 M39 46 l2 0" stroke="#d2ebb4" stroke-width="1" stroke-linecap="round"/></svg>',
    '<svg viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"><ellipse cx="30" cy="56" rx="14" ry="3" fill="#0a2c12" opacity=".26"/><path d="M11 41 q-3 -14 7 -14 q8 0 7 11 l-4 0 q1 -7 -3 -7 q-4 0 -3 10Z" fill="#3e9c4a"/><path d="M49 43 q3 -16 -7 -16 q-8 0 -7 12 l4 0 q-1 -8 3 -8 q4 0 3 12Z" fill="#3e9c4a"/><g fill="#f5688a"><circle cx="24" cy="31" r="2.6"/><circle cx="30" cy="29" r="2.8"/><circle cx="36" cy="31" r="2.6"/></g><circle cx="30" cy="30" r="1.4" fill="#fcd34d"/><path d="M21 55 q-3 -27 9 -27 q12 0 9 27Z" fill="#44a850"/><circle cx="25.5" cy="40" r="3.4" fill="#fff"/><circle cx="34.5" cy="40" r="3.4" fill="#fff"/><circle cx="26.1" cy="40.6" r="1.8" fill="#0e3416"/><circle cx="33.9" cy="40.6" r="1.8" fill="#0e3416"/><circle cx="25" cy="39.2" r=".8" fill="#fff"/><circle cx="32.8" cy="39.2" r=".8" fill="#fff"/><path d="M26 45.5 q4 2.5 8 0" fill="none" stroke="#226430" stroke-width="1.6" stroke-linecap="round"/><path d="M19 40 l-2 -1 M41 40 l2 -1 M20 45 l-2 0 M40 45 l2 0 M30 50 l-1.5 1 M30 50 l1.5 1" stroke="#d2ebb4" stroke-width="1" stroke-linecap="round"/></svg>',
    '<svg viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"><ellipse cx="30" cy="57" rx="14" ry="2.8" fill="#0a2c12" opacity=".28"/><path d="M11 42 q-3 -14 7 -14 q8 0 7 11 l-4 0 q1 -7 -3 -7 q-4 0 -3 10Z" fill="#388c44"/><path d="M49 44 q3 -16 -7 -16 q-8 0 -7 12 l4 0 q-1 -8 3 -8 q4 0 3 12Z" fill="#388c44"/><path d="M30 5 l2.6 5 5.4 .6 -4 3.8 1 5.4 -5 -2.7 -5 2.7 1 -5.4 -4 -3.8 5.4 -.6Z" fill="#f9cf4d" stroke="#dca91e" stroke-width=".9" stroke-linejoin="round" transform="translate(0,16)"/><path d="M21 56 q-3 -27 9 -27 q12 0 9 27Z" fill="#3ea04a"/><circle cx="25.5" cy="41" r="3.4" fill="#fff"/><circle cx="34.5" cy="41" r="3.4" fill="#fff"/><circle cx="26.1" cy="41.6" r="1.8" fill="#0a2e12"/><circle cx="33.9" cy="41.6" r="1.8" fill="#0a2e12"/><circle cx="25" cy="40.2" r=".8" fill="#fff"/><circle cx="32.8" cy="40.2" r=".8" fill="#fff"/><path d="M26 46.5 q4 2.5 8 0" fill="none" stroke="#1e5c2a" stroke-width="1.6" stroke-linecap="round"/><path d="M19 41 l-2 -1 M41 41 l2 -1 M20 46 l-2 0 M40 46 l2 0" stroke="#d2ebb4" stroke-width="1" stroke-linecap="round"/></svg>'
   ],
   lbl:['Cactus-Spruitje','Klein Cactusje','Jonge Cactus','Stekel-Cactus','Bloeiende Cactus','Gouden Cactus','Woestijnkoning'],
   desc:['Een klein spruitje dat tegen alles bestand is.','Stevig en geduldig, groeit langzaam maar zeker.','Eerste echte stekels - prikt nieuwsgierig rond.','Onverstoorbaar. Overleeft de droogste examenweek.','In bloei! Onder de stekels schuilt schoonheid.','Verguld van stekel tot bloem. Bijna onaantastbaar.','De woestijnkoning. Bloeit waar anderen verdorren.'],
   evoMsg:['🌵 Je spruitje is tegen alles bestand!','🌵 Eerste stekels! Je Cactus prikt nieuwsgierig rond.','🌵 Stekel-Cactus - onverstoorbaar en taai.','🌵 BLOEIENDE CACTUS! Onder je stekels schuilt schoonheid.','🏅 GOUDEN CACTUS! Je glanst als puur goud.','👑 WOESTIJNKONING! De ultieme, gekroonde vorm.']},
  {id:'robot', n:'Robot', s:['','','','','',''], fallback:['🤖','🤖','🤖','🤖','🤖','🤖'],
   svg:[
    '<svg viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"><ellipse cx="30" cy="51" rx="11" ry="3" fill="#1f3a5a" opacity=".18"/><line x1="30" y1="20" x2="30" y2="14" stroke="#8a98a8" stroke-width="2" stroke-linecap="round"/><circle cx="30" cy="12" r="2.4" fill="#3aa0e0"/><rect x="18" y="22" width="24" height="20" rx="7" fill="#aeb9c6" stroke="#7a8694" stroke-width="2"/><rect x="21" y="27" width="18" height="10" rx="4" fill="#1d2838"/><circle cx="26" cy="32" r="2.4" fill="#46d0f0"/><circle cx="34" cy="32" r="2.4" fill="#46d0f0"/><circle cx="25.4" cy="31.4" r=".7" fill="#fff"/><circle cx="33.4" cy="31.4" r=".7" fill="#fff"/></svg>',
    '<svg viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"><ellipse cx="30" cy="52" rx="12" ry="3" fill="#1f3a5a" opacity=".2"/><line x1="30" y1="20" x2="30" y2="12" stroke="#8a98a8" stroke-width="2.2" stroke-linecap="round"/><circle cx="30" cy="10" r="2.8" fill="#3aa0e0"/><rect x="15" y="22" width="30" height="22" rx="8" fill="#a6b2c0" stroke="#76828f" stroke-width="2"/><rect x="13" y="30" width="3" height="7" rx="1.5" fill="#8a98a8"/><rect x="44" y="30" width="3" height="7" rx="1.5" fill="#8a98a8"/><rect x="19" y="27" width="22" height="12" rx="5" fill="#1a2533"/><circle cx="25" cy="33" r="2.8" fill="#46d0f0"/><circle cx="35" cy="33" r="2.8" fill="#46d0f0"/><circle cx="24.3" cy="32.2" r=".8" fill="#fff"/><circle cx="34.3" cy="32.2" r=".8" fill="#fff"/></svg>',
    '<svg viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"><ellipse cx="30" cy="54" rx="13" ry="3" fill="#142a44" opacity=".22"/><line x1="30" y1="19" x2="30" y2="10" stroke="#8a98a8" stroke-width="2.4" stroke-linecap="round"/><circle cx="30" cy="8" r="3" fill="#34c0a0"/><rect x="13" y="21" width="34" height="24" rx="9" fill="#aab6c4" stroke="#727e8b" stroke-width="2"/><rect x="11" y="29" width="3" height="8" rx="1.5" fill="#828f9d"/><rect x="46" y="29" width="3" height="8" rx="1.5" fill="#828f9d"/><rect x="17" y="26" width="26" height="14" rx="5" fill="#172230"/><circle cx="24" cy="33" r="3" fill="#46d0f0"/><circle cx="36" cy="33" r="3" fill="#46d0f0"/><circle cx="23.2" cy="32.1" r=".9" fill="#fff"/><circle cx="35.2" cy="32.1" r=".9" fill="#fff"/><path d="M25 38 h10" stroke="#34c0a0" stroke-width="1.4" stroke-linecap="round"/></svg>',
    '<svg viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"><ellipse cx="30" cy="55" rx="14" ry="3" fill="#0e2038" opacity=".24"/><line x1="22" y1="18" x2="20" y2="9" stroke="#8a98a8" stroke-width="2.2" stroke-linecap="round"/><line x1="38" y1="18" x2="40" y2="9" stroke="#8a98a8" stroke-width="2.2" stroke-linecap="round"/><circle cx="20" cy="7" r="2.6" fill="#f06a6a"/><circle cx="40" cy="7" r="2.6" fill="#34c0a0"/><rect x="11" y="20" width="38" height="26" rx="10" fill="#a4b0bf" stroke="#6c7884" stroke-width="2"/><rect x="9" y="29" width="3.5" height="9" rx="1.6" fill="#7c8997"/><rect x="47.5" y="29" width="3.5" height="9" rx="1.6" fill="#7c8997"/><rect x="15" y="25" width="30" height="16" rx="6" fill="#141f2c"/><circle cx="23" cy="33" r="3.2" fill="#52d8f5"/><circle cx="37" cy="33" r="3.2" fill="#52d8f5"/><circle cx="22.1" cy="32" r="1" fill="#fff"/><circle cx="36.1" cy="32" r="1" fill="#fff"/><path d="M24 38.5 q6 2 12 0" fill="none" stroke="#34c0a0" stroke-width="1.5" stroke-linecap="round"/></svg>',
    '<svg viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"><ellipse cx="30" cy="56" rx="15" ry="3" fill="#0a1830" opacity=".26"/><line x1="21" y1="17" x2="18" y2="7" stroke="#94a2b2" stroke-width="2.4" stroke-linecap="round"/><line x1="39" y1="17" x2="42" y2="7" stroke="#94a2b2" stroke-width="2.4" stroke-linecap="round"/><circle cx="18" cy="5" r="2.8" fill="#f06a6a"/><circle cx="42" cy="5" r="2.8" fill="#34c0a0"/><rect x="9" y="19" width="42" height="28" rx="11" fill="#9eabba" stroke="#66727e" stroke-width="2"/><rect x="7" y="28" width="4" height="10" rx="1.8" fill="#76838f"/><rect x="49" y="28" width="4" height="10" rx="1.8" fill="#76838f"/><rect x="13" y="24" width="34" height="18" rx="7" fill="#101b28"/><circle cx="22.5" cy="33" r="3.4" fill="#5ee0fa"/><circle cx="37.5" cy="33" r="3.4" fill="#5ee0fa"/><circle cx="21.5" cy="31.9" r="1.1" fill="#fff"/><circle cx="36.5" cy="31.9" r="1.1" fill="#fff"/><path d="M23 39 q7 2.5 14 0" fill="none" stroke="#34c0a0" stroke-width="1.6" stroke-linecap="round"/><rect x="27" y="20.5" width="6" height="2" rx="1" fill="#5ee0fa"/></svg>',
    '<svg viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"><ellipse cx="30" cy="57" rx="15" ry="2.8" fill="#0a1830" opacity=".28"/><line x1="21" y1="18" x2="18" y2="8" stroke="#94a2b2" stroke-width="2.4" stroke-linecap="round"/><line x1="39" y1="18" x2="42" y2="8" stroke="#94a2b2" stroke-width="2.4" stroke-linecap="round"/><circle cx="18" cy="6" r="2.8" fill="#f06a6a"/><circle cx="42" cy="6" r="2.8" fill="#34c0a0"/><rect x="9" y="20" width="42" height="28" rx="11" fill="#9eabba" stroke="#66727e" stroke-width="2"/><path d="M30 2 l2.6 5 5.4 .6 -4 3.8 1 5.4 -5 -2.7 -5 2.7 1 -5.4 -4 -3.8 5.4 -.6Z" fill="#f9cf4d" stroke="#dca91e" stroke-width=".9" stroke-linejoin="round"/><rect x="7" y="29" width="4" height="10" rx="1.8" fill="#76838f"/><rect x="49" y="29" width="4" height="10" rx="1.8" fill="#76838f"/><rect x="13" y="25" width="34" height="18" rx="7" fill="#0e1825"/><circle cx="22.5" cy="34" r="3.4" fill="#6ae8ff"/><circle cx="37.5" cy="34" r="3.4" fill="#6ae8ff"/><circle cx="21.5" cy="32.9" r="1.1" fill="#fff"/><circle cx="36.5" cy="32.9" r="1.1" fill="#fff"/><path d="M23 40 q7 2.5 14 0" fill="none" stroke="#34c0a0" stroke-width="1.6" stroke-linecap="round"/></svg>'
   ],
   lbl:['Mini-Bot','Piepklein Botje','Leer-Robot','Studie-Droid','Mega-Brein','Gouden Robot','Super-AI'],
   desc:['Een klein botje dat net opgestart is. Beep boop.','Verwerkt elke vraag in milliseconden.','Leeralgoritme online. Slaat alle stof op.','Rekent foutloos, onthoudt feilloos.','Een brein van staal. Geen vraag te moeilijk.','Verguld van schroef tot scherm. Bijna onaantastbaar.','De super-AI. Kent het antwoord voor je het vraagt.'],
   evoMsg:['🤖 Beep boop! Je Mini-Bot is opgestart.','🤖 Leeralgoritme online! Je Robot slaat alles op.','🤖 Studie-Droid rekent foutloos en onthoudt feilloos.','🤖 MEGA-BREIN! Geen vraag is te moeilijk.','🏅 GOUDEN ROBOT! Je behuizing glanst als puur goud.','👑 SUPER-AI! De ultieme, gekroonde vorm.']},
  {id:'gorilla', n:'Gorilla', s:['','','','','',''], fallback:['🐒','🦍','🦍','🦍','🦍','🦍'],
   svg:[
    '<svg viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"><ellipse cx="30" cy="51" rx="12" ry="3" fill="#1a1f26" opacity=".18"/><circle cx="18" cy="26" r="5" fill="#3a4048"/><circle cx="42" cy="26" r="5" fill="#3a4048"/><circle cx="18" cy="26" r="2.4" fill="#5a4a40"/><circle cx="42" cy="26" r="2.4" fill="#5a4a40"/><circle cx="30" cy="33" r="15" fill="#42484f"/><ellipse cx="30" cy="38" rx="10" ry="8" fill="#6a5548"/><circle cx="24.5" cy="32" r="3.8" fill="#fff"/><circle cx="35.5" cy="32" r="3.8" fill="#fff"/><circle cx="25" cy="33" r="2.1" fill="#1a120c"/><circle cx="35" cy="33" r="2.1" fill="#1a120c"/><circle cx="24" cy="31.6" r=".9" fill="#fff"/><circle cx="34" cy="31.6" r=".9" fill="#fff"/><ellipse cx="27" cy="38" rx="1.2" ry="1.6" fill="#3a2c22"/><ellipse cx="33" cy="38" rx="1.2" ry="1.6" fill="#3a2c22"/><path d="M26 42 q4 2.5 8 0" fill="none" stroke="#3a2c22" stroke-width="1.4" stroke-linecap="round"/></svg>',
    '<svg viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"><ellipse cx="30" cy="52" rx="13" ry="3" fill="#1a1f26" opacity=".2"/><circle cx="17" cy="25" r="5.4" fill="#363c44"/><circle cx="43" cy="25" r="5.4" fill="#363c44"/><circle cx="17" cy="25" r="2.6" fill="#5a4a40"/><circle cx="43" cy="25" r="2.6" fill="#5a4a40"/><circle cx="30" cy="33" r="16" fill="#3e444b"/><ellipse cx="30" cy="38" rx="10.5" ry="8.5" fill="#6a5548"/><circle cx="24" cy="32" r="4" fill="#fff"/><circle cx="36" cy="32" r="4" fill="#fff"/><circle cx="24.5" cy="33" r="2.2" fill="#17100a"/><circle cx="35.5" cy="33" r="2.2" fill="#17100a"/><circle cx="23.4" cy="31.5" r="1" fill="#fff"/><circle cx="34.4" cy="31.5" r="1" fill="#fff"/><ellipse cx="27" cy="38" rx="1.3" ry="1.7" fill="#34281e"/><ellipse cx="33" cy="38" rx="1.3" ry="1.7" fill="#34281e"/><path d="M26 42.5 q4 2.5 8 0" fill="none" stroke="#34281e" stroke-width="1.5" stroke-linecap="round"/></svg>',
    '<svg viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"><ellipse cx="30" cy="54" rx="14" ry="3" fill="#10141a" opacity=".22"/><circle cx="15" cy="24" r="5.8" fill="#30363e"/><circle cx="45" cy="24" r="5.8" fill="#30363e"/><circle cx="15" cy="24" r="2.8" fill="#564640"/><circle cx="45" cy="24" r="2.8" fill="#564640"/><circle cx="30" cy="33" r="17" fill="#3a4047"/><ellipse cx="30" cy="38" rx="11" ry="9" fill="#685346"/><path d="M30 22 q-6 1 -8 6" stroke="#2e343b" stroke-width="2" fill="none" stroke-linecap="round" opacity=".6"/><circle cx="23.5" cy="32" r="4.2" fill="#fff"/><circle cx="36.5" cy="32" r="4.2" fill="#fff"/><circle cx="24" cy="33" r="2.3" fill="#140e08"/><circle cx="36" cy="33" r="2.3" fill="#140e08"/><circle cx="22.8" cy="31.4" r="1" fill="#fff"/><circle cx="34.8" cy="31.4" r="1" fill="#fff"/><ellipse cx="27" cy="38" rx="1.4" ry="1.8" fill="#30241a"/><ellipse cx="33" cy="38" rx="1.4" ry="1.8" fill="#30241a"/><path d="M25.5 42.5 q4.5 3 9 0" fill="none" stroke="#30241a" stroke-width="1.6" stroke-linecap="round"/></svg>',
    '<svg viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"><ellipse cx="30" cy="55" rx="15" ry="3" fill="#0a0e14" opacity=".24"/><circle cx="13" cy="23" r="6.2" fill="#2a3038"/><circle cx="47" cy="23" r="6.2" fill="#2a3038"/><circle cx="13" cy="23" r="3" fill="#524238"/><circle cx="47" cy="23" r="3" fill="#524238"/><circle cx="30" cy="33" r="18.5" fill="#363c44"/><path d="M16 28 q14 -6 28 0" fill="none" stroke="#a8aeb6" stroke-width="2.4" opacity=".4"/><ellipse cx="30" cy="38" rx="11.5" ry="9.5" fill="#665244"/><circle cx="23" cy="31" r="4.4" fill="#fff"/><circle cx="37" cy="31" r="4.4" fill="#fff"/><circle cx="23.6" cy="32" r="2.4" fill="#100b06"/><circle cx="36.4" cy="32" r="2.4" fill="#100b06"/><circle cx="22.4" cy="30.4" r="1.1" fill="#fff"/><circle cx="35.2" cy="30.4" r="1.1" fill="#fff"/><path d="M18 27 q4 -2 7 0 M42 27 q-4 -2 -7 0" stroke="#22272e" stroke-width="1.7" fill="none" stroke-linecap="round"/><ellipse cx="27" cy="38" rx="1.5" ry="1.9" fill="#2c2016"/><ellipse cx="33" cy="38" rx="1.5" ry="1.9" fill="#2c2016"/><path d="M25 43 q5 3 10 0" fill="none" stroke="#2c2016" stroke-width="1.7" stroke-linecap="round"/></svg>',
    '<svg viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"><ellipse cx="30" cy="56" rx="16" ry="3" fill="#06090e" opacity=".26"/><circle cx="12" cy="22" r="6.6" fill="#242a32"/><circle cx="48" cy="22" r="6.6" fill="#242a32"/><circle cx="12" cy="22" r="3.2" fill="#4e3e34"/><circle cx="48" cy="22" r="3.2" fill="#4e3e34"/><circle cx="30" cy="33" r="19.5" fill="#323840"/><path d="M14 27 q16 -7 32 0" fill="none" stroke="#b4bac2" stroke-width="3" opacity=".5"/><ellipse cx="30" cy="38" rx="12" ry="10" fill="#645040"/><circle cx="22.5" cy="31" r="4.6" fill="#fff"/><circle cx="37.5" cy="31" r="4.6" fill="#fff"/><circle cx="23.1" cy="32" r="2.5" fill="#0c0804"/><circle cx="36.9" cy="32" r="2.5" fill="#0c0804"/><circle cx="21.9" cy="30.3" r="1.2" fill="#fff"/><circle cx="35.7" cy="30.3" r="1.2" fill="#fff"/><path d="M17 26 q5 -2 8 0 M43 26 q-5 -2 -8 0" stroke="#1c2026" stroke-width="1.8" fill="none" stroke-linecap="round"/><ellipse cx="27" cy="38" rx="1.6" ry="2" fill="#281c12"/><ellipse cx="33" cy="38" rx="1.6" ry="2" fill="#281c12"/><path d="M24.5 43.5 q5.5 3 11 0" fill="none" stroke="#281c12" stroke-width="1.8" stroke-linecap="round"/></svg>',
    '<svg viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"><ellipse cx="30" cy="57" rx="16" ry="2.8" fill="#06090e" opacity=".28"/><circle cx="12" cy="23" r="6.6" fill="#20262e"/><circle cx="48" cy="23" r="6.6" fill="#20262e"/><circle cx="12" cy="23" r="3.2" fill="#4e3e34"/><circle cx="48" cy="23" r="3.2" fill="#4e3e34"/><circle cx="30" cy="34" r="19.5" fill="#2e343c"/><path d="M30 5 l3 5.5 6 .7 -4.5 4.3 1 6 -5.5 -3 -5.5 3 1 -6 -4.5 -4.3 6 -.7Z" fill="#f9cf4d" stroke="#dca91e" stroke-width="1" stroke-linejoin="round"/><path d="M14 28 q16 -7 32 0" fill="none" stroke="#bcc2ca" stroke-width="3" opacity=".55"/><ellipse cx="30" cy="39" rx="12" ry="10" fill="#645040"/><circle cx="22.5" cy="32" r="4.6" fill="#fff"/><circle cx="37.5" cy="32" r="4.6" fill="#fff"/><circle cx="23.1" cy="33" r="2.5" fill="#0c0804"/><circle cx="36.9" cy="33" r="2.5" fill="#0c0804"/><circle cx="21.9" cy="31.3" r="1.2" fill="#fff"/><circle cx="35.7" cy="31.3" r="1.2" fill="#fff"/><path d="M17 27 q5 -2 8 0 M43 27 q-5 -2 -8 0" stroke="#1a1e24" stroke-width="1.8" fill="none" stroke-linecap="round"/><ellipse cx="27" cy="39" rx="1.6" ry="2" fill="#281c12"/><ellipse cx="33" cy="39" rx="1.6" ry="2" fill="#281c12"/><path d="M24.5 44.5 q5.5 3 11 0" fill="none" stroke="#281c12" stroke-width="1.8" stroke-linecap="round"/></svg>'
   ],
   lbl:['Aapje','Klimmend Jonkie','Jonge Gorilla','Borstklopper','Zilverrug','Gouden Gorilla','Oer-Silverback'],
   desc:['Klein en speels, slingert van vraag naar vraag.','Klimt razendsnel van onderwerp naar onderwerp.','Klopt op zijn borst na elk goed antwoord. Terecht.','Sterk en kalm. Niets brengt hem van de wijs.','De zilverrug. De hele troep kijkt naar hem op.','Verguld van vacht tot vuist. Bijna onaantastbaar.','De oer-silverback. Rustig, machtig, onverslaanbaar.'],
   evoMsg:['🐒 Je aapje slingert van vraag naar vraag!','🦍 Je Gorilla klopt al op zijn borst. Terecht.','🦍 Jonge Gorilla - sterk, kalm en onverstoorbaar.','🦍 ZILVERRUG! De hele troep kijkt naar jou op.','🏅 GOUDEN GORILLA! Je vacht glanst als puur goud.','👑 OER-SILVERBACK! De ultieme, gekroonde vorm.']},
];
...
function openProfiel(){
  ...
  loadProfile();
  try{ if(typeof applyAccPrefs==='function') applyAccPrefs(); }catch(e){} // ververs toegankelijkheids-toggles (incl. soepele modus)
