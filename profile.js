...
const ANIMAL_EVOLUTIONS=[
  {id:'adelaar', n:'Adelaar', s:['','','','','',''], fallback:['🥚','🐣','🐥','🦅','🦅','🦅'],
   svg:[
    '<svg viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"><ellipse cx="30" cy="51" rx="17" ry="4" fill="#6b4520" opacity=".22"/><path d="M18 49 l5-3 4 3 4-3 4 3 4-3 4 3" fill="none" stroke="#7c5326" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M30 13 C40 13 46 27 46 37 C46 47 39 52 30 52 C21 52 14 47 14 37 C14 27 20 13 30 13Z" fill="#f3ead2" stroke="#b9914c" stroke-width="2"/><path d="M25 28 l4 4 -5 3 5 4 -4 4" fill="none" stroke="#a87c34" stroke-width="1.6" stroke-linejoin="round"/><circle cx="22" cy="25" r="1.5" fill="#cda35c"/><circle cx="38" cy="33" r="1.8" fill="#cda35c"/><circle cx="34" cy="44" r="1.4" fill="#cda35c"/><circle cx="21" cy="38" r="1.3" fill="#cda35c"/><ellipse cx="24" cy="24" rx="6" ry="3" fill="#fff" opacity=".45"/></svg>',
    '<svg viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"><ellipse cx="30" cy="53" rx="13" ry="3.5" fill="#6b4520" opacity=".2"/><path d="M13 40 q-4 -5 1 -8 M47 40 q4 -5 -1 -8" stroke="#d99a3a" stroke-width="3.2" fill="none" stroke-linecap="round"/><ellipse cx="30" cy="41" rx="14" ry="12.5" fill="#e7b85a"/><circle cx="30" cy="27" r="13.5" fill="#f2cd72"/><path d="M23 15 q1.5 -5 3.5 -.5 M30 13 q1.5 -5.5 3.5 -.5 M37 15 q-1.5 -5 -3.5 -.5" stroke="#e7b85a" stroke-width="3" fill="none" stroke-linecap="round"/><circle cx="24" cy="27" r="4.6" fill="#fff"/><circle cx="36" cy="27" r="4.6" fill="#fff"/><circle cx="24.4" cy="28" r="2.7" fill="#2a1a08"/><circle cx="35.6" cy="28" r="2.7" fill="#2a1a08"/><circle cx="23.3" cy="26.6" r=".9" fill="#fff"/><circle cx="34.6" cy="26.6" r=".9" fill="#fff"/><path d="M27 32 l3 -2.2 3 2.2 -3 3.2Z" fill="#f5a01e" stroke="#c2660a" stroke-width=".9" stroke-linejoin="round"/></svg>',
    '<svg viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"><ellipse cx="30" cy="54" rx="13" ry="3.5" fill="#5a3a1a" opacity=".22"/><path d="M11 30 q-6 8 0 16 q5 -2 8 -6Z" fill="#8b5a2b" stroke="#5a3a1a" stroke-width="1.6" stroke-linejoin="round"/><path d="M49 30 q6 8 0 16 q-5 -2 -8 -6Z" fill="#8b5a2b" stroke="#5a3a1a" stroke-width="1.6" stroke-linejoin="round"/><path d="M13 40 q-2 4 0 8 M47 40 q2 4 0 8" stroke="#6b4520" stroke-width="1.3" fill="none" opacity=".5"/><ellipse cx="30" cy="40" rx="14.5" ry="14" fill="#a06a32"/><circle cx="30" cy="26" r="14" fill="#c98a3c"/><path d="M16 22 q14 -8 28 0" fill="none" stroke="#b07a30" stroke-width="1.3" opacity=".55"/><circle cx="23" cy="26" r="5.2" fill="#fff"/><circle cx="37" cy="26" r="5.2" fill="#fff"/><circle cx="23.4" cy="26.5" r="3" fill="#f59e0b"/><circle cx="36.6" cy="26.5" r="3" fill="#f59e0b"/><circle cx="23.4" cy="26.5" r="1.6" fill="#1a0a00"/><circle cx="36.6" cy="26.5" r="1.6" fill="#1a0a00"/><circle cx="22.4" cy="25.4" r=".9" fill="#fff"/><circle cx="35.6" cy="25.4" r=".9" fill="#fff"/><path d="M18 22 q5 -2 8 1 M42 22 q-5 -2 -8 1" stroke="#7c5326" stroke-width="1.6" fill="none" stroke-linecap="round"/><path d="M26 31 q4 -2 8 0 q-1 4 -4 6 q-3 -2 -4 -6Z" fill="#f6b40e" stroke="#c98a00" stroke-width="1.4" stroke-linejoin="round"/></svg>',
    '<svg viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"><ellipse cx="30" cy="55" rx="14" ry="3.5" fill="#3a250f" opacity=".25"/><path d="M9 26 q-7 10 1 20 q7 -3 11 -9Z" fill="#6b4520" stroke="#3a250f" stroke-width="1.6" stroke-linejoin="round"/><path d="M51 26 q7 10 -1 20 q-7 -3 -11 -9Z" fill="#6b4520" stroke="#3a250f" stroke-width="1.6" stroke-linejoin="round"/><path d="M12 33 q-2 5 1 10 M14 30 q-3 6 0 13 M48 33 q2 5 -1 10 M46 30 q3 6 0 13" stroke="#4a3015" stroke-width="1.2" fill="none" opacity=".55"/><ellipse cx="30" cy="41" rx="15" ry="15" fill="#7c5326"/><path d="M20 44 q10 6 20 0" fill="none" stroke="#5a3a1a" stroke-width="1.3" opacity=".5"/><circle cx="30" cy="25" r="15" fill="#8b5a2b"/><path d="M16 18 q14 -7 28 0" fill="none" stroke="#9c6a32" stroke-width="1.4" opacity=".6"/><circle cx="22.5" cy="25" r="5.4" fill="#fff7e8"/><circle cx="37.5" cy="25" r="5.4" fill="#fff7e8"/><circle cx="23" cy="25.5" r="3.1" fill="#f59e0b"/><circle cx="37" cy="25.5" r="3.1" fill="#f59e0b"/><circle cx="23" cy="25.5" r="1.6" fill="#1a0a00"/><circle cx="37" cy="25.5" r="1.6" fill="#1a0a00"/><circle cx="21.9" cy="24.4" r="1" fill="#fff"/><circle cx="35.9" cy="24.4" r="1" fill="#fff"/><path d="M16 20 q6 -3 10 0 M44 20 q-6 -3 -10 0" stroke="#5a3a1a" stroke-width="2" fill="none" stroke-linecap="round"/><path d="M27 30 q3 -2 6 0 q0 3 -1 6 q1 2 -2 3 q-3 -1 -2 -3 q-1 -3 -1 -6Z" fill="#f6b40e" stroke="#b8780a" stroke-width="1.4" stroke-linejoin="round"/></svg>',
    '<svg viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"><ellipse cx="30" cy="56" rx="15" ry="3.5" fill="#2a1a08" opacity=".28"/><path d="M7 22 q-8 11 0 23 q9 -3 13 -10Z" fill="#5a3a1a" stroke="#2a1a08" stroke-width="1.7" stroke-linejoin="round"/><path d="M53 22 q8 11 0 23 q-9 -3 -13 -10Z" fill="#5a3a1a" stroke="#2a1a08" stroke-width="1.7" stroke-linejoin="round"/><path d="M10 30 q-3 6 1 13 M13 26 q-4 7 0 16 M50 30 q3 6 -1 13 M47 26 q4 7 0 16" stroke="#3a250f" stroke-width="1.3" fill="none" opacity=".6"/><ellipse cx="30" cy="42" rx="15.5" ry="15" fill="#6b4520"/><path d="M19 46 q11 6 22 0 M21 50 q9 4 18 0" fill="none" stroke="#4a3015" stroke-width="1.2" opacity=".5"/><path d="M14 24 Q30 8 46 24 Q44 30 30 31 Q16 30 14 24Z" fill="#f6f2e9" stroke="#d8cfbe" stroke-width="1.4"/><path d="M30 12 q-9 2 -14 11 M30 12 q9 2 14 11" fill="none" stroke="#e6dcc7" stroke-width="1.2" opacity=".7"/><circle cx="22.5" cy="24" r="5.2" fill="#fff"/><circle cx="37.5" cy="24" r="5.2" fill="#fff"/><circle cx="23.2" cy="24.5" r="3" fill="#f59e0b"/><circle cx="36.8" cy="24.5" r="3" fill="#f59e0b"/><circle cx="23.2" cy="24.5" r="1.6" fill="#0a0500"/><circle cx="36.8" cy="24.5" r="1.6" fill="#0a0500"/><circle cx="22.1" cy="23.3" r="1" fill="#fff"/><circle cx="35.7" cy="23.3" r="1" fill="#fff"/><path d="M16 20 q6 -1 9 2 M44 20 q-6 -1 -9 2" stroke="#caa24e" stroke-width="2.2" fill="none" stroke-linecap="round"/><path d="M27 28 q3 -1.5 6 0 q0.5 4 -1 8 q1.5 2 -2 3.5 q-3.5 -1.5 -2 -3.5 q-1.5 -4 -1 -8Z" fill="#f6b40e" stroke="#b8780a" stroke-width="1.5" stroke-linejoin="round"/><path d="M28.5 29.5 q1.5 -1 3 0" stroke="#fff" stroke-width="1" fill="none" opacity=".5"/></svg>',
    '<svg viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"><ellipse cx="30" cy="57" rx="15" ry="3" fill="#2a1a08" opacity=".3"/><path d="M3 16 Q-2 30 8 44 Q14 36 19 30 Q11 22 8 16 Q5 14 3 16Z" fill="#4a3015" stroke="#2a1a08" stroke-width="1.6" stroke-linejoin="round"/><path d="M57 16 Q62 30 52 44 Q46 36 41 30 Q49 22 52 16 Q55 14 57 16Z" fill="#4a3015" stroke="#2a1a08" stroke-width="1.6" stroke-linejoin="round"/><path d="M6 20 q-3 7 2 18 M10 18 q-4 9 1 22 M54 20 q3 7 -2 18 M50 18 q4 9 -1 22" stroke="#2a1a08" stroke-width="1.3" fill="none" opacity=".55"/><path d="M14 24 Q30 14 46 24 L42 34 Q30 30 18 34Z" fill="#6b4520"/><ellipse cx="30" cy="42" rx="15" ry="14.5" fill="#5a3a1a"/><path d="M20 46 q10 6 20 0 M22 50 q8 4 16 0" fill="none" stroke="#3a250f" stroke-width="1.2" opacity=".5"/><path d="M30 5 l2.5 5 5.5 .6 -4 4 1 5.4 -5-2.8 -5 2.8 1-5.4 -4-4 5.5-.6Z" fill="#f6c544" stroke="#d49a18" stroke-width="1" stroke-linejoin="round"/><path d="M13 23 Q30 7 47 23 Q45 30 30 31 Q15 30 13 23Z" fill="#f8f4ec" stroke="#d8cfbe" stroke-width="1.4"/><path d="M30 11 q-10 2 -15 11 M30 11 q10 2 15 11" fill="none" stroke="#e6dcc7" stroke-width="1.2" opacity=".7"/><circle cx="22" cy="23" r="5.4" fill="#fff"/><circle cx="38" cy="23" r="5.4" fill="#fff"/><circle cx="22.8" cy="23.5" r="3.1" fill="#fbbf24"/><circle cx="37.2" cy="23.5" r="3.1" fill="#fbbf24"/><circle cx="22.8" cy="23.5" r="1.6" fill="#0a0500"/><circle cx="37.2" cy="23.5" r="1.6" fill="#0a0500"/><circle cx="21.6" cy="22.2" r="1.1" fill="#fff"/><circle cx="36" cy="22.2" r="1.1" fill="#fff"/><path d="M15 19 q6 -1 9 2.5 M45 19 q-6 -1 -9 2.5" stroke="#d4a534" stroke-width="2.4" fill="none" stroke-linecap="round"/><path d="M26.5 27 q3.5 -1.5 7 0 q0.5 4.5 -1 9 q2 2 -2.5 4 q-4.5 -2 -2.5 -4 q-1.5 -4.5 -1 -9Z" fill="#f6b40e" stroke="#b8780a" stroke-width="1.5" stroke-linejoin="round"/><path d="M28 28.5 q2 -1 4 0" stroke="#fff" stroke-width="1.1" fill="none" opacity=".5"/><path d="M25 52 l-2 5 M30 53 l0 5 M35 52 l2 5" stroke="#f6b40e" stroke-width="2.2" stroke-linecap="round"/></svg>'
   ],
   lbl:['Verward Ei','Pluizig Kuiken','Jonge Pieper','Bruine Jager','Witkop-Adelaar','Hemelheerser'],
   desc:['Ligt te broeden op kennis. Komt er bijna uit.','Donzig en nieuwsgierig, piept bij elke vraag.','Eerste veren, eerste oefenvluchten. Valt nog vaak.','Scherpe blik, jaagt op hoge cijfers.','Witte kop, gouden blik. Niets ontgaat hem meer.','Met gespreide vleugels en kroon torent hij boven elk examen uit.'],
   evoMsg:['🐣 Je ei is uit! Een donzig kuikentje piept van trots.','🐥 Eerste veren! Je Adelaar waagt zijn eerste vlucht.','🦅 Bruine jager ontwaakt - scherpe blik, scherpe geest.','🦅 WITKOP-ADELAAR! De examinator voelt de wind van je vleugels.','👑 HEMELHEERSER ONTGRENDELD! Het ultieme niveau. Jij zweeft.']},
