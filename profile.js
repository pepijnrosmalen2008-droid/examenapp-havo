...
const ANIMAL_EVOLUTIONS=[
  ...
  {id:'haai', n:'Haai', s:['','','','','',''], fallback:['🐟','🐠','🦈','🦈','🦈','🦈'],
   ...
   lbl:['Mini-Haai','Nieuwsgierig Visje','Jonge Jager','Roofvis','Witte Haai','Oerhaai'],
   desc:['Zo groot als een vinger, maar bijt al van zich af.','Zwemt nieuwsgierig rond elke vraag.','Eerste tandjes, eerste overwinningen.','Ruikt een goede score van mijlenver.','Niets ontsnapt aan zijn kaken. Ook fouten niet.','De oerhaai uit de diepte. Examens trillen in het water.'],
   evoMsg:['🐟 Je visje is geboren en hapt al naar kennis!','🐠 Eerste tandjes! Je Haai jaagt op vragen.','🦈 Roofvis ontwaakt - scherpe blik, scherpe tanden.','🦈 WITTE HAAI! De examinator durft het water niet meer in.','👑 OERHAAI ONTGRENDELD! De ultieme vorm uit de diepte.']},
  ...
  {id:'uil', n:'Uil', s:['','','','','',''], fallback:['🥚','🐣','🦉','🦉','🦉','🦉'],
   ...
   lbl:['Uilen-Ei','Pluizig Uiltje','Jonge Oehoe','Wijze Waker','Grote Oehoe','Orakeluil'],
   desc:['Broedt op wijsheid. Komt er bijna uit.','Donzig en grootogig, knippert bij elke vraag.','Eerste veren en oortjes, blijft de hele nacht wakker.','Ziet in het donker welk antwoord klopt.','Niets ontgaat zijn enorme ogen. Echt niets.','Het alziend orakel met kroon. Kent het antwoord al.'],
   evoMsg:['🐣 Je ei is uit! Een donzig uiltje knippert wijs.','🦉 Eerste oortjes! Je Uil blijft de hele nacht oefenen.','🦉 Wijze waker ontwaakt - ziet in het donker.','🦉 GROTE OEHOE! Niets ontgaat zijn enorme ogen.','👑 ORAKELUIL ONTGRENDELD! De ultieme, alwetende vorm.']},
  ...
  {id:'slang', n:'Slang', s:['','','','','',''], fallback:['🥚','🐍','🐍','🐍','🐍','🐍'],
   ...
   lbl:['Slang-Ei','Kronkelaar','Jonge Adder','Gladde Jager','Brilcobra','Oerslang'],
   desc:['Een glad eitje. Er kronkelt al wat binnenin.','Klein maar wendbaar, glijdt door de stof.','Eerste gifttandjes, eerste lastige vragen.','Sluipt geruisloos naar hoge cijfers.','Spreidt zijn schild en hypnotiseert het examen.','De oerslang met kroon. Wijs, oud en onverslaanbaar.'],
   evoMsg:['🐍 Je slang is uit het ei! Een kronkelend kereltje.','🐍 Eerste gifttandjes! Je Slang glijdt door de stof.','🐍 Gladde jager ontwaakt - geruisloos en scherp.','🐍 BRILCOBRA! Het examen kijkt als gehypnotiseerd toe.','👑 OERSLANG ONTGRENDELD! De ultieme, gekroonde vorm.']},
  // ── CUSTOM SVG DIEREN ────────────────────────────
