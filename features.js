...
function showLevelUp(lvl, lvlName, xpAdded){
  ...
  try{if(typeof vonkPlay==='function')vonkEvent('level_up',{el:el.querySelector('.lvlup-vonk'),silent:true});}catch(e){}
...
function slagioVlagUit(kind){
  ...
  try{
    ...
    try{if(typeof vonkPlay==='function')vonkEvent('level_up',{el:ov.querySelector('.vlag-vonk'),silent:true});}catch(e){}
...
function renderHomeStats(){
  ...
  try{if(typeof renderDagmissie==='function')renderDagmissie();}catch(e){}
  try{if(typeof renderSlimHome==='function')renderSlimHome();}catch(e){}
