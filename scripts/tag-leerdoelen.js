...
const DOMEIN_LO = { bi: { M1: 'bi.M.1', M2: 'bi.M.2', M3: 'bi.M.3', M4: 'bi.M.4', M5: 'bi.M.5', M6: 'bi.M.6', M7: 'bi.M.7', O1: 'bi.O.1', O2: 'bi.O.2', O3: 'bi.O.3', O4: 'bi.O.4', O5: 'bi.O.5', O6: 'bi.O.6', O7: 'bi.O.7', P1: 'bi.P.1', P2: 'bi.P.2', P3: 'bi.P.3', P4: 'bi.P.4', P5: 'bi.P.5', P6: 'bi.P.6', A1: 'bi.A.1', A2: 'bi.A.2', A3: 'bi.A.3', A4: 'bi.A.4', A5: 'bi.A.5' } };
...
const OVERRIDES_ALL = {
  bi: {
    ...
    "Wat is het verschil tussen optimum en denaturatie?": 'bi.M.3',
    "Wat gebeurt er met het enzym ná de reactie?": 'bi.M.3',
    "Waarom breekt amylase wel zetmeel af, maar geen eiwit?": 'bi.M.3',
    "Na verhitting tot 60 °C werkt een enzym niet meer, ook niet na afkoelen. Waarom?": 'bi.M.3',
    "Pepsine werkt bij pH 2, maar niet bij pH 7. Waarom?": 'bi.M.3',
