...
SLAGIO_EXAMENS.havo.en = {
  ...
  vragen: [
    ...
    // ── Opgave 2 ──
    { nr:4, opgave:2, punten:3, type:'open', domein:'Leesvaardigheid',
      vraag:'De tekst zegt dat tieners "more time than ever before" naar schermen kijken. Bepaal met afbeelding 2 het verschil in schermtijd tussen de groep 18-20 jaar en de groep 12-14 jaar, en beoordeel daarna of deze infographic de bewering "than ever before" echt kan bewijzen. Leg je oordeel uit.',
      antwoord:'De groep 18-20 jaar kijkt gemiddeld 8 uur per dag, de groep 12-14 jaar 5 uur; dat is 3 uur per dag meer. De infographic kan de bewering "than ever before" echter niet echt bewijzen: de grafiek vergelijkt alleen verschillende leeftijdsgroepen op dit moment, niet dezelfde groep door de jaren heen. Er staan geen cijfers van vroeger in, dus je kunt er niet uit aflezen dat de schermtijd hoger is dan ooit; daarvoor zou je gegevens over de tijd (bijvoorbeeld 2005 vs 2025) nodig hebben.',
      antwoord_rubric:'1 punt: verschil = 3 uur per dag (8 en 5 afgelezen). 1 punt: de grafiek vergelijkt leeftijdsgroepen nu, geen ontwikkeling door de tijd. 1 punt: conclusie dat "than ever before" hiermee niet te bewijzen is (er ontbreken cijfers van vroeger).' },
    ...
    // ── Opgave 3 ──
    { nr:6, opgave:3, punten:3, type:'open', domein:'Leesvaardigheid',
      vraag:'Wat wilden de onderzoekers met dit onderzoek te weten komen (het doel)? Leg daarna uit waarom het gebruik van twee groepen (afbeelding 3) de conclusie betrouwbaarder maakt dan wanneer ze maar één groep hadden onderzocht.',
      antwoord:'De onderzoekers wilden weten of korte pauzes studenten helpen zich beter te concentreren. Door twee groepen te vergelijken die alleen verschillen in het wel of niet nemen van pauzes, kunnen ze het effect van de pauzes zuiver meten: als de pauzegroep beter presteert, komt dat verschil hoogstwaarschijnlijk door de pauzes en niet door toeval of een andere factor. Met maar één groep zou je geen vergelijking hebben en niet weten of de pauzes echt het verschil maakten.',
      antwoord_rubric:'1 punt: doel = onderzoeken of korte pauzes de concentratie helpen/verbeteren. 1 punt: twee groepen die alleen in de pauzes verschillen maken een zuivere vergelijking mogelijk. 1 punt: daardoor is het verschil toe te schrijven aan de pauzes en niet aan toeval/andere factoren.' },
