...
SLAGIO_EXAMENS.havo.ak = {
  ...
  vragen: [
    ...
    // ── Opgave 2 · Bevolking ──
    { nr:3, opgave:2, punten:3, type:'open', domein:'Bevolking',
      vraag:'Leid uit de vorm van de piramide af in welke fase van de demografische transitie dit land vermoedelijk zit. Voorspel daarna hoe de vorm van de piramide er over ongeveer 40 jaar uitziet als het geboortecijfer in die periode sterk daalt, en verklaar die verandering.',
      antwoord:'De brede basis en de snel smaller wordende top wijzen op een hoog geboortecijfer en een nog jonge bevolking; dat past bij fase 2 van de demografische transitie (sterfte al gedaald, geboortecijfer nog hoog). Als het geboortecijfer sterk daalt, wordt de basis over 40 jaar veel smaller: er komen minder jonge kinderen bij (ontgroening). Tegelijk schuift de nu grote groep jongeren omhoog naar de midden- en oudere leeftijdsgroepen, waardoor de piramide verandert van een driehoek naar een meer klok- of urnvorm en de vergrijzing begint.',
      antwoord_rubric:'1 punt: fase 2, onderbouwd met de brede basis/jonge bevolking (hoog geboortecijfer). 1 punt: basis wordt smaller (ontgroening) → meer klok-/urnvorm. 1 punt: de huidige grote groep jongeren schuift omhoog → vergrijzing.' },
    ...
    { nr:7, opgave:4, punten:3, type:'open', domein:'Verstedelijking',
      vraag:'Bepaal met afbeelding 4 in welk jaar de lage-inkomenslanden ongeveer 50% verstedelijkt waren. Verklaar daarna waarom hun lijn veel steiler stijgt dan die van de hoge-inkomenslanden; betrek de economische ontwikkeling (industrialisatie) in je antwoord.',
      antwoord:'De lijn van de lage-inkomenslanden bereikt ongeveer 50% rond het jaar 2000 (aflezen). De lijn stijgt steil omdat deze landen pas laat, maar dan in korte tijd, industrialiseren: er ontstaat in de steden veel werk in fabrieken en diensten, waardoor in een korte periode enorm veel mensen van het platteland naar de stad trekken. De hoge-inkomenslanden waren rond 1960 al grotendeels verstedelijkt (hun industrialisatie was al veel eerder gebeurd), dus daar valt weinig meer bij te winnen en blijft de lijn vlak.',
      antwoord_rubric:'1 punt: ongeveer 2000 afgelezen. 1 punt: lage-inkomenslanden industrialiseren nu (laat maar snel) → veel stadsbanen → snelle trek naar de stad. 1 punt: hoge-inkomenslanden al eerder verstedelijkt/geïndustrialiseerd → lijn blijft vlak.' },
    { nr:8, opgave:4, punten:3, type:'open', domein:'Verstedelijking',
      vraag:'De snelle verstedelijking in lage-inkomenslanden gaat vaak gepaard met het ontstaan van sloppenwijken. Leg met een push- én een pullfactor uit hoe zulke wijken ontstaan, en beoordeel of de snelle verstedelijking voor deze landen vooral een kans of een probleem is. Onderbouw je oordeel.',
      antwoord:'Door pushfactoren (armoede, werkloosheid, misoogsten op het platteland) en pullfactoren (hoop op werk en een beter leven in de stad) trekken heel veel mensen in korte tijd naar de stad. Dat gaat sneller dan er woningen, banen en voorzieningen bijkomen, waardoor nieuwkomers in zelfgebouwde sloppenwijken zonder goede voorzieningen belanden. Oordeel (genuanceerd): de verstedelijking is deels een kans, want de stad biedt werk, onderwijs en economische groei; maar deels ook een probleem, door sloppenwijken, grote druk op voorzieningen en toenemende ongelijkheid. Een goed antwoord kiest een kant én erkent de andere.',
      antwoord_rubric:'1 punt: push + pull → toestroom sneller dan woningen/werk/voorzieningen → sloppenwijken. 1 punt: één kant onderbouwd (kans: werk/onderwijs/groei, óf probleem: sloppenwijken/druk/ongelijkheid). 1 punt: genuanceerd oordeel dat ook de andere kant erkent.' },
    // ── Opgave 5 · Water ──
