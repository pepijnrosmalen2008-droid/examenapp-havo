...
var _ECAFB = {
  ...
  koopkracht:(function(){
    ...
    return '<svg viewBox="0 0 360 196" role="img" aria-label="prijsindex en loonindex over drie jaren">'+yl+_ecAx()+pl+ll+dots+'<g font-family="sans-serif" font-size="9.5" font-weight="800"><text x="322" y="'+(sy(116)+3).toFixed(1)+'" fill="#e8580c" text-anchor="end">prijsindex</text><text x="322" y="'+(sy(108)+13).toFixed(1)+'" fill="#2563eb" text-anchor="end">loonindex</text></g>'+xl+'<text x="0" y="0" transform="translate(18,90) rotate(-90)" font-family="sans-serif" font-size="9.5" font-weight="800" fill="#1b2230" text-anchor="middle">indexcijfer</text></svg>';
  })(),
